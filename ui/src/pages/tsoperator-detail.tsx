...
import { getDeploymentStatus, getOperatorVersion, toSimpleContainer } from '@/lib/k8s'
...
export function TypesenseOperatorDetail(props: { namespace: string; name: string }) {
            ...
            content: (
              <div className="space-y-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-6 space-y-6">
